...
import { Trmcolombia2Service } from './services/trmcolombia2.service';
import { Coinmarketcap2Service } from './services/coinmarketcap2.service';
...
export class Table2Component implements DoCheck, OnInit{
  ...
  constructor(private trmcolombiaService: Trmcolombia2Service, private coinmarketcapService: Coinmarketcap2Service){
    this.precioDolar = 0;
    this.cantidad= 0;
    this.manualtrm = 0;
